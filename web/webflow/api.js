...
(function () {
  ...
  function Ve(e, t) {
    var a = {
      ...
      v;
    return (
      (v = { next: h(0), throw: h(1), return: h(2) }),
  ...
  var St = function (e) {
      var t,
        ...
        c =
          e.state === Ce.FailureFeedback ||
          e.state === Ce.FailureHavingTroubles,
        l,
        v = L(
          Mr,
          (l =
  ...
  function pr() {
    ...
    var t = e.src,
      a = { loadedAsync: !1, params: new URLSearchParams(), src: t };
  ...
  var It = function (e, t, a) {
      var o = Tt(t.params, !1),
        ...
        h = ""
          ...
          .concat(
            (v = t.params.theme) !== null && v !== void 0 ? v : t.theme,
            "/"
          )
          .concat(a);
      ...
      for (
        ...
        if (!(s.isComplete || s.isFailed || s.isResetting)) {
          ...
          if (
            ((s.isExecuting ||
              !s.isInitialized ||
              (s.isInitialized && !s.isStale && !s.isExecuted)) &&
              s.watchcat.lastAckedSeq !== 0 &&
              k) ||
            N
          ) {
          ...
          (p = A.contentWindow) === null ||
            p === void 0 ||
            p.postMessage(
              { source: W, widgetId: h, seq: e.watchCatSeq, event: "meow" },
              "*"
            );
        }
      }
    ...
    if (!(t === void 0 || t.hasResponseParamEl)) {
      ...
      if (o) {
        ...
        if (
          ...
          Rr((v = t.params.sitekey) !== null && v !== void 0 ? v : "")
        ) {
  ...
  function Tr(e, t) {
    ...
    if (
      (o !== null && P(o, HTMLInputElement) && (o.value = t),
  ...
  var Dt = (function () {
    var e = function (n, i, r, u) {
      ...
      o = function (n) {
        if (!n) return [];
        for (
          var i = n.attributes, r = i.length, u = new Array(r), d = 0;
          d < r;
          d++
        )
          u[d] = i[d].name;
      ...
      v = function (n) {
        ...
        try {
          for (
            var d = y.widgetMap[Symbol.iterator](), m;
            !(i = (m = d.next()).done);
            i = !0
          ) {
            var w = Ie(m.value, 2),
      ...
      h = function (n, i, r) {
        for (; n.msgQueue.length > 0; ) {
          ...
          (u = r.contentWindow) === null ||
            u === void 0 ||
            u.postMessage({ source: W, widgetId: i, event: d }, "*");
        }
      },
      s = function (n, i) {
        if (i) {
      ...
      _ = function (n, i) {
        ...
        if (u) {
          ...
          (!m || !w) &&
            g("Widget ".concat(r, " to reset was not found."), 3330),
      ...
      A = function (n) {
        ...
        var w =
          (i = y.widgetMap.get(r)) === null || i === void 0
            ? void 0
            : i.retryTimeout;
      ...
      T = function (n, i) {
        ...
        try {
          for (
            var D = y.widgetMap.values()[Symbol.iterator](), B;
            !(E = (B = D.next()).done);
            E = !0
          ) {
            var te = B.value;
        ...
        if (V) {
          ...
          var ne;
          f.execution =
            (ne = f.execution) !== null && ne !== void 0 ? ne : me.Render;
          var _e;
          f.appearance =
            (_e = f.appearance) !== null && _e !== void 0 ? _e : Q.Always;
          var ie;
          f["retry-interval"] = Number(
            (ie = f["retry-interval"]) !== null && ie !== void 0 ? ie : ar
          );
          var be;
          f["expiry-interval"] = Number(
            (be = f["expiry-interval"]) !== null && be !== void 0
              ? be
              : (Jt - Zt) * 1e3
          );
          var de;
          ...
          typeof H != "string" &&
            g(
              'Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(
                typeof H == "undefined" ? "undefined" : F(H),
                '"'
              ),
              3588
            ),
            Kt(H) ||
              g(
                'Invalid input for parameter "sitekey", got "'.concat(H, '"'),
                3589
              ),
            pt(f.size) ||
              g(
          ...
          var Re,
            J =
              (Re = f["refresh-expired"]) !== null && Re !== void 0
                ? Re
                : Z.Auto;
          vt(J)
            ? (f["refresh-expired"] = J)
            : g(
                'Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'
                  .concat(J, '" ')
                  .concat(typeof J == "undefined" ? "undefined" : F(J)),
                3603
              );
          var Se,
            oe =
              (Se = f["refresh-timeout"]) !== null && Se !== void 0
                ? Se
                : ce.Auto;
          mt(J)
            ...
            : g(
                'Invalid type for parameter "refresh-timeout", expected never|manual|auto, got "'
                  .concat(oe, '" ')
                  .concat(typeof oe == "undefined" ? "undefined" : F(oe)),
                3603
              );
          var j = document.createElement("iframe"),
            fe = document.createElement("div"),
            Vt = fe.attachShadow({ mode: "closed" });
          dt(he) ||
            g(
              'Invalid input for optional parameter "action", got "'.concat(
                he,
          ...
          if (!(!Ae || !pe)) {
            ...
            var at,
              Ar =
                (at = f["response-field"]) !== null && at !== void 0 ? at : !0;
            if (Ar) {
              ...
              if (
                ((Me.name =
                  (nt = f["response-field-name"]) !== null && nt !== void 0
                    ? nt
                    : xt),
      ...
      k = function () {
        ...
        try {
          for (
            var m = y.widgetMap[Symbol.iterator](), w;
            !(r = (w = m.next()).done);
            r = !0
          ) {
            var E = Ie(w.value, 2),
            ...
            switch (V.label) {
              case 0:
                ...
                (m = "h/".concat("g", "/")),
                  ...
                  (D = ""
                    .concat(E, "://")
                    .concat(w.host, "/cdn-cgi/challenge-platform/")
                    .concat(m, "rc/")
                    .concat(r)
                    .concat(S)),
                  (V.label = 1);
                ...
                return (
                  ...
                  [
                    ...
                    fetch(D, {
                      ...
                      redirect: "manual",
                      body: JSON.stringify({ sitekey: u, secondaryToken: i }),
                    }),
                  ]
                );
              case 2:
            ...
            switch (n.event) {
              case "init": {
                ...
                d ||
                  ...
                  (r.nextRcV = n.nextRcV),
                  r.mode === q.Invisible &&
                    r.params["refresh-expired"] === Z.Manual &&
                    x(
                  ...
                  r.mode !== q.Managed &&
                    r.params["refresh-timeout"] !== ce.Auto &&
                    x(
                      "setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."
                    ),
                  r.params.appearance === Q.Always ||
                  (r.isExecuting && r.params.appearance === Q.Execute)
                    ? Mt(d, r)
                    : xr(d),
                  (d.style.display = "");
                ...
                m ||
                  ...
                  (u = m.contentWindow) === null ||
                    u === void 0 ||
                    u.postMessage(
                      { source: W, widgetId: n.widgetId, event: "init" },
                      "*"
                    );
                break;
              }
              ...
              case "fail": {
                ...
                if (B) {
                  var te,
                    V = r.shadow.querySelector("#".concat(i));
                  V == null ||
                    (te = V.contentWindow) === null ||
                    te === void 0 ||
                    te.postMessage(
                      { source: W, widgetId: n.widgetId, event: "forceFail" },
                      "*"
                    );
                }
                if (D) {
                  var f;
                  D(String((f = n.code) !== null && f !== void 0 ? f : Qt))
                    ? r.params.retry === ve.Auto && !r.isResetting && t(r, i, B)
                    : (n.code && x("Error: ".concat(n.code, ".")), t(r, i, B));
                } else
                  n.code
                    ? (t(r, i, B), g("Error: ".concat(n.code), 3076))
                    : t(r, i, !1);
                break;
              }
              case "feedbackInit": {
              ...
              case "requestFeedbackData": {
                var re,
                  ke = r.shadow.querySelector("#".concat(i));
                ke ||
                  g(
              ...
              case "turnstileResults": {
                var H,
                  ae,
                  se =
                    (H = r.wrapper.parentNode) === null || H === void 0
                      ? void 0
                      : H.querySelector("#".concat(i, "-fr"));
                se ||
                  g(
                    "Received state for an unknown widget: ".concat(n.widgetId),
                    3078
                  ),
                  (ae = se.contentWindow) === null ||
                    ae === void 0 ||
                    ae.postMessage(
                      {
                        source: W,
              ...
              case "closeFeedbackReportIframe": {
                var ne,
                  _e =
                    (ne = r.wrapper.parentNode) === null || ne === void 0
                      ? void 0
                      : ne.querySelector("#".concat(i, "-fr"));
                _e ||
                  g(
                    "Received state for an unknown widget: ".concat(n.widgetId),
                    3078
              ...
              case "tokenExpired": {
                ...
                (r.isExpired = !0),
                  (ie = r.cbExpired) === null ||
                    ie === void 0 ||
                    ie.call(r, be),
                  r.params["refresh-expired"] === Z.Auto &&
                    !r.isResetting &&
                    _(z.AutoExpire, i);
                break;
              }
              case "interactiveTimeout": {
                ...
                if (
                  (de
                    ? de()
                    : r.params["refresh-timeout"] === ce.Never &&
                      !r.isResetting &&
                      x(
                    ...
                    Pe(
                      {
                        ...
                        timeRenderMs:
                          r.widgetRenderEndTimeMs - r.widgetRenderStartTimeMs,
                        timeToInitMs:
                          r.widgetInitStartTimeMs - r.widgetRenderEndTimeMs,
                        timeToParamsMs:
                          r.widgetParamsStartTimeMs - r.widgetInitStartTimeMs,
                        tiefTimeMs: Se,
                      },
                      Je
                    ),
      ...
      execute: function (n, i) {
        ...
        if (d) {
          ...
          d.isExpired &&
            ...
            d.isStale && (_(z.StaleExecute, m), (d.isExecuting = !0)),
  ...
  function qr(e) {
    ...
    c &&
      (ct(c)
        ? (a.theme = c)
        : x('Unknown data-theme value: "'.concat(c, '".')));
    var l = e.getAttribute("data-size");
    if (
      (l &&
        (pt(l)
          ? (a.size = l)
          : x('Unknown data-size value: "'.concat(l, '".'))),
      0)
    )
      var v;
    ...
    var i,
      r =
        (i = e.getAttribute("data-response-field")) !== null && i !== void 0
          ? i
          : "true";
  ...
  (ge = !1),
    (C = pr()),
    (y.scriptWasLoadedAsync =
      (Ye = C == null ? void 0 : C.loadedAsync) !== null && Ye !== void 0
        ? Ye
        : !1),
    (y.scriptUrl =
      (Qe = C == null ? void 0 : C.src) !== null && Qe !== void 0
        ? Qe
        : "undefined"),
    C != null &&
      C.params &&
      ((ye = C.params.get("compat")),
      (ye == null ? void 0 : ye.toLowerCase()) === "recaptcha"
        ? window.grecaptcha
          ? x(
        ...
        : ye !== null &&
          x('Unknown value for api.js?compat: "'.concat(ye, '", ignoring.')),
    ...
    Lt && !ge
      ...
      : (Lt &&
          ...
          (C == null || (Ke = C.params) === null || Ke === void 0
            ? void 0
            : Ke.get("render")) !== "explicit" && setTimeout(Ft, 0)),
        (window.turnstile = Dt),
        ge ||
          ((C == null || ($e = C.params) === null || $e === void 0
            ? void 0
            : $e.get("render")) !== "explicit" && Pt.push(Ft),
